...
describe('Questionanire and QuestionnaireResponses transformation', () => {
    ...
    test('Each FHIR QuestionnaireResponse should convert to FCE', async () => {
        ...
        expect(toFirstClassExtension(gad7_fhir_QuestionnaireResponse)).toStrictEqual(gad7_aidbox_QuestionnaireResponse);
        ...
        expect(toFirstClassExtension(allergies_inprogress_fhir_QuestionnaireResponse)).toStrictEqual(
